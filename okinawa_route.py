# @Time : 2025/03/26 12:41
# @Author : kahyuu
# @File : okinawa_route.py
# @Software : PyCharm
# -*- coding: utf-8 -*-
...
# 创建底图（冲绳岛中心坐标，以那霸市为中心）
m = folium.Map(location=[26.2124, 127.6809], zoom_start=11, tiles='OpenStreetMap',
               control_scale=True)
...
# 保存地图
m.save('okinawa_travel_map.html')